...
internal sealed class Three : Number
{
    public override void Render(BoardCharacter[][] output, int startIndex)
    {
        output[0][startIndex] = output[0][startIndex + 1] = output[0][startIndex + 2] =
        output[1][startIndex + 3] =
        output[2][startIndex + 1] = output[2][startIndex + 2] =
        output[3][startIndex + 3] =
        output[4][startIndex + 3] =
        output[5][startIndex] = output[5][startIndex + 1] = output[5][startIndex + 2] = BoardCharacter.White;
    }
}